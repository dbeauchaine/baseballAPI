...
namespace BaseballAPI.ApiModels
{
    public class BattingStatsMapper : IBattingStatsMapper
    {
        ...
        public BattingLeaderBoardStats MapYear(Batting batting)
        {
            ...
            {
                NameFirst = batting.Player.NameFirst,
                NameLast = batting.Player.NameLast,
                NameGiven = batting.Player.NameGiven,
                PlayerId = batting.PlayerId,
                YearId = batting.YearId,
                Stint = batting.Stint,
                TeamId = batting.TeamId,
            ...
            ConvertOptionalLeaderboardParamsToNonNullable(batting, battingLeaderboardStats);

            return battingLeaderboardStats;
        }
        ...
        private void ConvertOptionalLeaderboardParamsToNonNullable(Batting batting, BattingLeaderBoardStats battingStats)
        {
            if (batting.G != null)
                battingStats.G = (short)batting.G;
            else
